<script lang="ts">
  ...
  const rounds = [
    { round: 1, score: 150, date: "2025-11-26", time: "12:34" },
    { round: 2, score: 95, date: "2025-11-25", time: "08:45" },
    { round: 3, score: 120, date: "2025-11-24", time: "15:20" }
  ];
...
<div class="min-h-screen bg-gradient-to-b from-blue-50 to-white">
  <Header {score} {time} onMenuClick={handleMenuClick} />
  ...
  <div class="px-5 py-6">
    ...
    <div class="space-y-3">
      {#each rounds as round, i}
        <div class="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 hover:shadow-md transition-shadow animate-in fade-in slide-in-from-bottom-2 duration-300" style="animation-delay: {i * 50}ms">
    ...
    <div class="mt-8 bg-blue-50 rounded-2xl p-6 border border-blue-200">
      ...
      <p class="text-4xl font-bold text-blue-900">{rounds.reduce((sum, r) => sum + r.score, 0)} poäng</p>
    </div>
  </div>
</div>
